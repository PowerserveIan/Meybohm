	...
	$(function() {
		...
		var u = navigator.userAgent.toLowerCase(),
			...
			css_string = '' + 
				...
				'.jstree a { display:inline-block; line-height:16px; height:16px; color:black; white-space:pre-wrap; text-decoration:none; padding:1px 2px; margin:0; } ' + 
...
(function ($) {
	...
	$(function() {
		var css_string = '.jstree .ui-icon { overflow:visible; } .jstree a { padding:1px 2px; }';
		$.vakata.css.add_sheet({ str : css_string });
	});
})(jQuery);
//*/
