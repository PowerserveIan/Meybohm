...
(function() {
	...
	if (window.tinymce) {
		...
		tinymce.ScriptLoader.load((tinymce.PluginManager.urls['filemanager'] || tinymce.baseURL + '/plugins/filemanager') + '/language/default.aspx?type=fm&format=tinymce_3_x&group=tinymce&prefix=filemanager_');
	}
	...
	if (window.TinyMCE_Engine) {
		var TinyMCE_FileManagerPlugin = {
			setup : function() {
				...
				document.write('<script type="text/javascript" src="' + b + '/plugins/filemanager/language/default.aspx?type=fm&format=tinymce&group=tinymce&prefix=filemanager_"></script>');
			},
