<%@ Page Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" Inherits="AdminBuilder" CodeFile="admin-builder.aspx.cs" %>
...
<asp:Content ContentPlaceHolderID="ContentWindow" runat="server">
	...
	<h4 class="indent paddingTop" data-bind="visible: listings().length == 0">There are no Builders to edit. Add a Builder by clicking the Add New button above.</h4>
</asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="PageSpecificJS">
	<script type="text/javascript">
		appendToListing = function (index, item, thisListing) {
			thisListing.Id = item.BuilderID;
