<%@ Page Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" Inherits="AdminNewsPressCategory" CodeFile="admin-news-press-category.aspx.cs" Title="Admin - Newspress Category Manager" %>
...
<asp:Content ContentPlaceHolderID="ContentWindow" runat="server">
	...
	<h4 class="indent paddingTop" data-bind="visible: listings().length == 0">There are no News &amp; Press Categories to edit. Add a Category by clicking the 'Add New' button above.</h4>
</asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="PageSpecificJS">
	<script type="text/javascript">
		appendToListing = function (index, item, thisListing) {
			thisListing.Id = item.NewsPressCategoryID;
