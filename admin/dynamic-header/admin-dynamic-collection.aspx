<%@ Page Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" Inherits="AdminDynamicCollection" CodeFile="admin-dynamic-collection.aspx.cs" Title="Admin - Dynamic Collection Manager" %>
		...
		<tbody data-bind="foreach: listings">
			<tr data-bind="css:{odd:index() % 2 == 0}">
				...
				<td>
					...
					<a href='#' class="icon delete or" data-bind="click: function(){if(confirm('Are you sure you want to delete this collection?'))deleteRecord();}">Delete</a>
					<input type='hidden' data-bind="value:Id" />
				</td>
			</tr>
		</tbody>
	</table>
	<h4 class="indent paddingTop" data-bind="visible: listings().length == 0">There are no Dynamic Collections to edit. Add a Dynamic Collection by clicking the Add New button above.</h4>
</asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="PageSpecificJS">
	<script type="text/javascript">
		appendToListing = function (index, item, thisListing) {
			thisListing.Id = item.DynamicCollectionID;
