<%@ Page Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" Inherits="AdminMailingList" CodeFile="admin-mailing-list.aspx.cs" Title="Admin - Mailing List Manager" %>
...
<asp:Content ContentPlaceHolderID="ContentWindow" runat="server">
	...
	<asp:Label runat="server" ID="uxNoMoreMailingLists" />
	...
	<h4 class="indent paddingTop" data-bind="visible: listings().length == 0">There are no Mailing Lists to edit. Add a Mailing List by clicking the Add New button above..</h4>
</asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="PageSpecificJS">
	<script type="text/javascript">
		appendToListing = function (index, item, thisListing) {
			thisListing.Id = item.MailingListID;
